...
@section('title', 'Beranda - Portal Alumni SMK Negeri 1')
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div class="space-y-6">
                ...
                <div class="flex flex-wrap gap-4 pt-2">
                    ...
                    <a href="{{ route('donasi') }}" class="px-6 py-3.5 bg-blue-500 text-white hover:bg-blue-600 font-bold rounded-xl border border-blue-400/40 shadow-lg shadow-blue-650/20 transition-all flex items-center gap-2">
            ...
            <div class="flex flex-col sm:flex-row gap-6 p-6 rounded-2xl bg-slate-50 border border-slate-100">
                ...
                <div class="space-y-3">
                    ...
                    <p class="text-sm text-slate-600 leading-relaxed">
                        "Selamat datang kembali di wadah alumni. Sekolah selalu bangga atas dedikasi dan kontribusi para alumni di tengah masyarakat dan dunia usaha."
                    </p>
                </div>
            </div>
    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            <div class="lg:col-span-2 space-y-8">
                <div class="flex items-center justify-between border-b border-slate-200 pb-4">
                    <h2 class="text-2xl font-bold tracking-tight text-slate-900">
                        <i class="fa-solid fa-newspaper text-blue-600 mr-2"></i>Berita Terbaru
                    </h2>
            ...
            <div class="space-y-8">
                <div class="flex items-center justify-between border-b border-slate-200 pb-4">
                    <h2 class="text-2xl font-bold tracking-tight text-slate-900">
                        <i class="fa-solid fa-calendar-days text-blue-600 mr-2"></i>Agenda Terdekat
                    </h2>
                ...
                <div class="bg-blue-900 rounded-2xl overflow-hidden text-white relative group">
                    <div class="aspect-video bg-slate-950 flex items-center justify-center relative">
                        <img src="https://images.unsplash.com/photo-1523050854058-8df90110c9f1?w=400" alt="Video Profil Cover" class="w-full h-full object-cover opacity-60 absolute inset-0">
                        <a href="https://www.youtube.com" target="_blank" class="h-12 w-12 rounded-full bg-white text-blue-900 flex items-center justify-center text-lg shadow-lg hover:scale-110 transition-transform relative z-10">
                            <i class="fa-solid fa-play"></i>
                        </a>
                    </div>
                    <div class="p-4 bg-blue-950/90 text-center">
                        <h4 class="text-xs font-bold uppercase tracking-wider">Video Profil Almamater</h4>
                        <p class="text-[10px] text-slate-400 mt-1">Saksikan kilas balik sarana & prasarana sekolah kita</p>
                    </div>
                </div>
            </div>
        </div>
...
<!-- Alumni Berprestasi & Testimonials -->
<section class="py-20 bg-white">
